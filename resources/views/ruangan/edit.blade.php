                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="{{ $ruangan -> kode_ruangan }}" id="kode_ruangan" class="form-control" placeholder="Kode Ruangan" name="kode_ruangan" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="{{ $ruangan -> nama_ruangan }}" id="nama_ruangan" class="form-control" placeholder="Nama Ruangan" name="nama_ruangan">
                        </div>
                    </div>
                </div>
